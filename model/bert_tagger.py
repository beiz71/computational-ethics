...
def main():
    ...
    if args.do_train:
        ...
        for _ in trange(int(args.num_train_epochs), desc="Epoch"):
            ...
            logging.info("  epoch loss = %f", epoch_loss[-1])
            print(f"epoch_{_} loss = {epoch_loss[-1]}")
    ...
    # Test model
    if args.do_test:
        clean_test_ex, dirty_test_ex = ma_processor.get_test_examples(args.data_dir)
        test_examples_seq = [clean_test_ex, dirty_test_ex]
        idx2setname = {0: 'clean', 1: 'dirty'}
